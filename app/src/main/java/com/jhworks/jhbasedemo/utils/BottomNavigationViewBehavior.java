...
public class BottomNavigationViewBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
        AppBarLayout.Behavior behavior = ((AppBarLayout.Behavior) ((CoordinatorLayout.LayoutParams) dependency.getLayoutParams()).getBehavior());
        //得到依赖View的滑动距离
        int top = 0;
        if (behavior != null)
            top = behavior.getTopAndBottomOffset();
