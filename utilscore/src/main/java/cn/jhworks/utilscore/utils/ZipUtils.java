        ...
        try {
            ...
            while ((zipEntry = inZip.getNextEntry()) != null) {
                ...
                if (zipEntry.isDirectory()) {
                    ...
                    CoreLog.info(TAG,destFileName);
                    File file = new File(destFileName);
                    if (!file.exists()) {
                        CoreLog.info(TAG,"create file: " + destFileName);
        ...
        try {
            ...
            if (TextUtils.isEmpty(extensionName) || !ZIP.equals(extensionName.toLowerCase())) {
                ...
                if (!TextUtils.isEmpty(lastFileNameNoEx)) {
                    ...
                    CoreLog.info(TAG,"构建zip完整路径成功: %s", destFile);
                }
            }
